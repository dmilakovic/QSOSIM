...
c Declare variables
     ...
     +                        sigblur
      INTEGER,DIMENSION(nobj) :: numlls, s2n
...
c Define data to be inputted into fits file
     ...
     &            'blls1','zlls1','nhills2','blls2','zlls2'/
      ...
      DATA tform2/'E','E','E','E','E','J','J','J','E','E','E','E','E',
     +            'E'/
      DATA tunit1/'','','','e12','e16','',''/
      DATA tunit2/'','','','','','','','','','','','','',''/
c Create the first binary table HDU
     ...
     &            extname,varidat,status)
      ...
      call ftgerr(status,errtext)
      print *,status,' ',errtext
c Create the second binary table HDU
      nrows=nobj
      tfields=14
      extname='QSO'
     ...
     &            extname,varidat,status)
      ...
      call FTPCLJ(unit,6,1,1,nrows,sigblur,status)
      call FTPCLJ(unit,7,1,1,nrows,s2n,status)
